	...
	return function (e) {
		...
		*/
		...
		t.default = function (e, t) {
			...
			i ? t && t() : o.default.sdkLoader("/media/scripts/av-min.js", "AV", function (n) {
				var r = "https://",
					o = "",
					a = e.app_id || e.appId,
		...
		var r = n(0),
			...
			s = function (e) {
				o.default.sdkLoader("https://api.ip.sb/jsonip?callback=getIP", "getIP"), window.getIP = function (t) {
